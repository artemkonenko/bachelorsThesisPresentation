...
\begin{frame}
\frametitle{Полученное ускорение}

\begin{block}{Оптимизация обхода ветвлений в управляющем графе}
К сожалению, дала очень небольшой эффект и только на процедурах специального вида
\end{block}

\begin{block}{Оптимизация межпроцедурного анализа}
Сильно сократила число повторных анализов.
\end{block}
