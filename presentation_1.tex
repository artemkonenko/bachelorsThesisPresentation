...
\begin{frame}
\frametitle{Почему анализ псевдонимов необходим}

\begin{enumerate}
\item для уточнения других анализов
\item для проверки выполнения предусловий применения преобразований
\end{enumerate}
\end{frame}
